...
# This should be a long, randomly generated string in a real application.
app.secret_key = os.urandom(24)

# --- In-memory product database---
# In a real life application, this data would be stored in database(e.g., SQL, NoSQL).
products = {
...
# --- HTML Template (Embedded for single-file operation) ---
# In a real Flask application, these would be separate.html files in a `templates` folder.
# We are embedding them here to meet the single file requirement.
